...
(function (PUREST) {
    ...
    function handleAddRule(baseElement, element, selector, rule) {
        if (rule.add) {
            element.setAttribute(selector.attributeSelector, rule.value);
        }
    }
    ...
    function handleObjectRule(baseElement, element, selector, rule) {
        ...
        if (rule.hasOwnProperty("items")) {
            ...
            handleAddRule(baseElement, element, selector, rule);
        } else {
    ...
    function handlePrimitiveTypeRule(baseElement, element, selector, rule) {
        if (selector.attributeSelector === '') {
            ...
            if (selector.append) {
                ...
                element.attributes[selector.attributeSelector].textContent = (typeof rule === 'undefined' ? 'undefined' : rule);
            }
        }
    }
    ...
    function render(selector, directive, target) {
        ...
        if (typeof target === 'undefined') {
            ...
            if (targetNode != null) {
                var lc = null;
                while (lc = targetNode.lastChild) {
                    targetNode.removeChild(lc);
                }
